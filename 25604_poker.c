...
void analyze_hand (const int in_rank_count[NRANKS],
                   const int in_suit_count[NSUITS],
                   bool *isstraight, bool *isflush, bool *isfour, bool *isthree, int *npairs);

void print_result (const int in_rank_count[NRANKS],
                   const int in_suit_count[NSUITS],
                   const bool in_hand[NRANKS][NSUITS],
                   bool *isstraight, bool *isflush, bool *isfour, bool *isthree, int *npairs);

void read_cards (int in_rank_count[NRANKS],
...
int main (void) {
    ...
    for (;;) {
        ...
        read_cards(in_rank_count, in_suit_count, in_hand);

        analyze_hand(in_rank_count, in_suit_count,
                     &isstraight, &isflush, &isfour, &isthree, &npairs);

        print_result(in_rank_count, in_suit_count, in_hand,
                     &isstraight, &isflush, &isfour, &isthree, &npairs);
